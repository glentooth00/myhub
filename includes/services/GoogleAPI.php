...
class GoogleAPI
{
  ...
  public function saveSpreadsheetRow(
    $spreadsheetId,
    $sheetName,
    array $headers,
    array $newRow,
    ...
    try {
      ...
      if ($pkIndex === false)
        throw new Exception('Primary key not found in headers');
      ...
      // Else: append new row
        ...
        $this->saveSpreadsheetData($spreadsheetId, $sheetName . '!A1', [$newRow]);
  ...
  public function callAppsScript($scriptId, $functionName, $parameters, $userEmail = null)
  {
    ...
    debug_log(
      compact('scriptId', 'functionName', 'userEmail'),
