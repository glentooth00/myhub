...
<div class="list-view">
  <div class="table-responsive">
    <table id="tccs-table" data-days="<?=$days?>" data-category="<?=$category?>">
      <thead>
        <tr>
          <th>Status</th>
          <th>PIN No</th>
...
<?php endforeach; ?>
    ...
    <button class="fab btn-round btn-primary" type="button"
      onclick="F1.app.navigateTo({url:'accountant/tccs?view=edit&id=-1', view:'edit', title:'TCC Form'})">
